...
// The pin package is exercised against a real apiserver: server-side apply
// field-manager semantics (co-ownership, conflicts, managedFields bookkeeping)
// are apiserver behaviour and cannot be faked.
